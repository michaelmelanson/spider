...
-export([parse/1, resolve/2, qualify/2]).
...
%% 2008-09-07 Michael Terry
%% Given a source url and a dependent url--which may be fully qualified,
%% domain absolute, or relative--and resolve a fully qualified URL:
%%
%% fully qualified: http://www.example.com/example.html
%% site absolute: /example.html
%% relative: example.html
%%
%% qualify("http://www.google.com/a/b","/c") -> "http://www.google.com/c"
qualify(Page_Url, Found_Url) ->
    case Found_Url of
	[$h,$t,$t,$p,$:,$/,$/|_] -> Found_Url;
	_ -> resolve(Page_Url, Found_Url)
    end.
